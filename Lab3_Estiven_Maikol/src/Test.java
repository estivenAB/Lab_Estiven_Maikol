...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        NationalPark park = new NationalPark(p.getGrant(), p.getIncomePerEntry(), " Manuel Antonio ", " Puntarenas ");
        NationalPark park2 = new NationalPark(p.getGrant(), p.getIncomePerEntry(), "Volcán Poás ", " Alajuela ");
